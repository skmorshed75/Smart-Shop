    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <input type="text" class="xd-none" id="updateID">
                                <input type="text" class="xd-none" id="filePath">
            ...
            <div class="modal-footer">
                <button onclick = "resetOptionData()" id="update-modal-close" class="btn bg-gradient-primary" data-bs-dismiss="modal" aria-label="Close">Close</button>
...
<script>
    ...
    async function update() {
        ...
        if (productCategoryUpdate.length === 0) {
            ...
            if(res.status===200 && res.data===1){
                successToast('Request completed hahaha');
                document.getElementById("update-form").reset();
                //resetOptionData();
                // let selectElement = document.getElementById("productCategoryUpdate");
    ...
    function resetOptionData(){
        let selectElement = document.getElementById("productCategoryUpdate");
        selectElement.innerHTML = "";
        //newImg.src="{{asset('images/default.jpg')}}"
        //alert("hello");
    }
</script>
